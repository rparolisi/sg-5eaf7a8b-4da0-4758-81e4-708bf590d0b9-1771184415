                            ...
                            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2 flex justify-center mb-4">
                                    <div className="bg-gray-100 p-1 rounded-lg flex">
                                        <button
                                            className={`px-6 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2 ${formData.type === 'Buy' ? 'bg-white text-green-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
